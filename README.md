<div align="center">
  ...
  **Сделай ЕТИС великим снова**
  ...
  [![Version](https://img.shields.io/badge/Версия-1.706-blue.svg)](https://raw.githubusercontent.com/defl-orator/etis-reborn/main/etis.user.js)
...
*   **Умные капсулы:** Визуальное отображение баллов сверху таблицы.
*   **Калькулятор баллов:** Наведите на капсулу оценки в триместре, чтобы узнать, сколько баллов не хватает до 3, 4 или 5.
*   **Графики и топы:** Автоматический расчет среднего балла, построение красивого графика успеваемости, и отображение топа предметов конкретного триместра.
...
*   **Поиск:** Мгновенный поиск по списку преподавателей, объявлений и сообщений от преподавателей.
